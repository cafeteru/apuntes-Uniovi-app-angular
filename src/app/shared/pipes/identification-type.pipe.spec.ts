...
describe('IdentificationTypePipe', () => {
  ...
  it('check transform with IdentificationType.DNI key', inject(
    [TranslateService],
    (translateService: TranslateService) => {
      const pipe = new IdentificationTypePipe(translateService);
      translateService.get('identification-type.dni').subscribe((res) => {
  ...
  it('check transform with IdentificationType.NIE key', inject(
    [TranslateService],
    (translateService: TranslateService) => {
      const pipe = new IdentificationTypePipe(translateService);
      translateService.get('identification-type.nie').subscribe((res) => {
